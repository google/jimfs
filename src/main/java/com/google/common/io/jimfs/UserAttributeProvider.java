 ...
 * @author Colin Decker
 */
class UserAttributeProvider implements AttributeProvider,
  ...
  private static class View extends AbstractAttributeView implements UserDefinedFileAttributeView {
    ...
    public View(UserAttributeProvider attributeProvider, FileProvider fileProvider) {
      super(attributeProvider, fileProvider);
    }

    @Override
    public List<String> list() throws IOException {
      return ((UserAttributeProvider) provider()).userDefinedAttributes(file());
    }
