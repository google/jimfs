 ...
 * you may not use this store except in compliance with the License.
...
public class ByteStoreFileChannelTest {
  ...
  private static ByteStoreFileChannel channel(ByteStore store, OpenOption... options)
      throws IOException {
    ImmutableSet<OpenOption> opts = ImmutableSet.copyOf(options);
    return new ByteStoreFileChannel(store, opts);
  }
