...
public abstract class File implements Serializable {
    ...
    private static final long serialVersionUID = -2251576112826413721L;
    ...
    /**
     * Returns the size, in bytes, of this file's content. Directories and symbolic
     * links have a size of 0.
     */
    public long size() {
        return 0;
    }
    ...
    /**
     * Creates a new file of the same type as this file with the given ID. Does not
     * copy the content of this file unless the cost of copying the content is
     * minimal. This is because this method is called with a hold on the file
     * system's lock.
     */
    abstract File copyWithoutContent(int id);

    /**
     * Copies the content of this file to the given file. The given file must be the
     * same type of file as this file and should have no content.
     *
     * <p>
     * This method is used for copying the content of a file after copying the file
    ...
    /**
     * Returns the read-write lock for this file's content, or {@code null} if there
     * is no content lock.
     */
    @Nullable
    ...
    /**
     * Called when a stream or channel to this file is closed. If there are no more
     * streams or channels open to the file and it has been deleted, its contents
     * may be deleted.
     */
    void closed() {
    }
    ...
    /**
     * Called when (a single link to) this file is deleted. There may be links
     * remaining. Does nothing by default.
     */
    void deleted() {
    }
    ...
    /**
     * Called when this file has been linked in a directory. The given entry is the
     * new directory entry that links to this file.
     */
    ...
    /**
     * Called when this file has been unlinked from a directory, either for a move
     * or delete.
     */
    void unlinked() {
    }
    ...
    /**
     * Returns the names of the attributes contained in the given attribute view in
     * the file's attributes table.
     */
    ...
    private synchronized void setFileTimes(long creationTime, long lastModifiedTime,
            long lastAccessTime) {
        this.creationTime = creationTime;
        this.lastModifiedTime = lastModifiedTime;
        this.lastAccessTime = lastAccessTime;
